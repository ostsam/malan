...
export default async function HistoryPage() {
  ...
  return (
    <div className="flex flex-col mt-10 items-center min-h-screen bg-gray-50 py-8">
      <div className="glassmorphic w-full max-w-2xl p-6 bg-white/80 rounded-lg shadow-md">
        ...
        {chats.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex space-x-4 mt-2">
                    <span className="text-sm text-gray-600">
                      Language: {chat.settings.selectedLanguageLabel}
                    </span>
                    <span className="text-sm text-gray-600">
                      Level: {chat.settings.selectedLevel}
                    </span>
                  </div>
          ...
          <div className="text-center py-10">
            ...
            <Link
              href="/"
              className="mt-4 inline-block px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Start a New Chat
            </Link>
          </div>
